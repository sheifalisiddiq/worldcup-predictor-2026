...
function RingsBackground({
  ...
  const PALETTE = ['#E8192C', '#1144CC', '#2CB82A', '#FFC800', '#00C8E8', '#7B2CBF', '#C9A427', '#066030'];
  ...
  for (let i = 0; i < rings; i++) {
    ...
    rectsR.push({
      ...
      h,
      rx,
      color: PALETTE[(i + seed + 4) % PALETTE.length],
      i
    });
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      transformOrigin: '420px 500px',
      animation: 'spinSlow 120s linear infinite'
    }
  }, rectsL.map(r => /*#__PURE__*/React.createElement("rect", {
    key: 'l' + r.i,
    x: r.x,
    y: r.y,
    width: r.w,
    ...
    style: {
      transformOrigin: '580px 500px',
      animation: 'spinSlow 150s linear infinite reverse'
    }
  }, rectsR.map(r => /*#__PURE__*/React.createElement("rect", {
    key: 'r' + r.i,
    x: r.x,
    y: r.y,
    width: r.w,
